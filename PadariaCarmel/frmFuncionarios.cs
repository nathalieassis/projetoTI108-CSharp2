...
namespace PadariaCarmel
{
    public partial class frmFuncionarios : Form
    {
        ...
        public void Cadastrarfuncionarios()
        {
           ...
           comm.CommandText = "insert into tbFuncionarios(nome,email,telCel,cpf,endereco,bairro,numero,cidade,estado,cep) values(@nome,@email,@telCel,@cpf,@endereco,@bairro,@numero,@cidade,@estado,@cep);";
            ...
            comm.Parameters.Add("@endereço", MySqlDbType.VarChar,100).Value = txtEnd.Text;
